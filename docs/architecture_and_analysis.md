...
## 2026 Rate Projection Logic
Toll Optimizer includes projected 2026 rates. When a trip is analyzed, the tool calculates:
1.  **Actual Cost**: What you paid (recorded in CSV).
2.  **Calculated Cost**: What the tool thinks you should have paid (validation).
3.  **2026 Projected Cost**: What the same trip will cost under the 2026 rate schedule.

This allows for highly accurate future budgeting based on historical travel patterns.
